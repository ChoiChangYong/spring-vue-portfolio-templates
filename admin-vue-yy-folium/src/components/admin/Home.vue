                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="customRadio1">
                                                        <img src="../../img/admin/bg-img/banner-home.jpg" alt="select image 1" title="select image 1"/>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-4">
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="customRadio2">
                                                        <img src="../../img/admin/bg-img/banner-home-black.jpg" alt="select image 1" title="select image 1"/>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
